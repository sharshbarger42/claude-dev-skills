...
3. **Priority label** — pick one based on severity/impact: `priority: high` (blocks users, service down, or data at risk), `priority: medium` (degraded functionality, normal queue), or `priority: low` (cosmetic, nice to have)
