# Repo Shorthand Table

Use this table to resolve shorthand repo names to their full `owner/repo` and local checkout path.

| Shorthand | Resolves to | Local path |
|-----------|-------------|------------|
| `food-automation` | `super-werewolves/food-automation` | `$HOME/gitea-repos/food-automation/` |
| `homelab-setup` | `super-werewolves/homelab-setup` | `$HOME/gitea-repos/homelab-setup/` |
