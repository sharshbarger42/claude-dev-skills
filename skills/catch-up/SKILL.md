...
### ACTIVE.md
!`cat $HOME/gitea-repos/productivity/ACTIVE.md`
...
!`tail -20 $HOME/gitea-repos/productivity/CHANGELOG.md`

### Standalone TODO files
!`find $HOME -maxdepth 1 -name '*TODO*' -o -name '*todo*' | head -10`

!`for f in $HOME/*TODO*; do [ -f "$f" ] && echo "=== $f ===" && cat "$f" && echo; done 2>/dev/null`
